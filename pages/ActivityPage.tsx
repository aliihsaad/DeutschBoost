...
const ActivityPage: React.FC = () => {
          ...
          <div className="space-y-4">
            ...
            {activity.questions.map((q: any, index: number) => (
              <Card key={index} className={userAnswers[index] === q.correct_option ? 'border-2 border-green-500 : 'border-2 border-red-500
                ...
                <p className="text-sm text-gray-600 mb-2">Your answer: <span className={userAnswers[index] === q.correct_option ? 'text-green-600 : 'text-red-600
    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold {currentQuestionIndex + 1} of {activity.questions.length}</h2>
  ...
  const renderVocabularyActivity = () => {
    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold {currentCardIndex + 1} of {activity.cards.length}</h2>
          <div className="text-sm text-gray-600
    ...
    return (
      <div className="space-y-6">
        <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200
          ...
          <p className="text-sm text-gray-600 words: {activity.min_words}</p>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-200
          <div className="text-center py-8">
            <div className="text-6xl mb-4">
              <i className="fa-solid fa-headphones text-indigo-600
            </div>
      ...
      <div className="space-y-6">
        ...
        <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200
          <div className="flex items-start gap-3 mb-3">
            <i className="fa-solid fa-book-open text-3xl text-amber-600
            <h3 className="text-xl font-bold text-amber-800 Passage</h3>
          </div>
