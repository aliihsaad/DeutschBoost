...
import { parseAiJsonResponse, safeJsonParse } from '../utils/safeJsonParse';
...
Be constructive, specific, and encouraging. Focus on practical improvements.`;
    ...
    const feedbackData = parseAiJsonResponse<ConversationFeedback>(response.text, 'conversation feedback');
